export default {
    ...
    config: {
        ...
        description: "Providers, model selection, sync, and storage",
        modalDescription: "Providers, default models, sync, and storage",
        tabs: {
            channels: "Providers",
        ...
        fileSecurity: "The JSON file contains API keys, WebDAV credentials, and object storage credentials. Keep it secure.",
        ...
        channelEditor: {
            ...
            arkPromptMode: "Prompt optimization",
            arkStandard: "Standard",
            arkFast: "Fast",
            arkPromptModeHint: "Fast mode supports Seedream 5.0 pro / 4.0, but not 5.0 lite / 4.5.",
            arkCustomScriptRequired: "Built-in Ark {{capability}} is not supported yet. Configure a request script for this model.",
            title: "Edit provider",
            name: "Provider name",
            protocol: "Protocol",
