export default {
    ...
    config: {
        ...
        description: "渠道聚合、模型选择、同步与存储",
        modalDescription: "渠道聚合、默认模型、同步与存储",
        tabs: {
            channels: "渠道",
            localProxy: "本地代理",
            preferences: "偏好设置",
        ...
        fileSecurity: "JSON 文件包含 API Key、WebDAV 和对象存储凭据，请妥善保管。",
        import: "导入配置",
        export: "导出配置",
        imported: "配置与用户偏好已导入",
        ...
        channelEditor: {
            ...
            arkStandard: "标准模式",
            arkFast: "快速模式",
            arkPromptModeHint: "快速模式适用于 Seedream 5.0 pro / 4.0，5.0 lite / 4.5 不支持。",
            arkCustomScriptRequired: "Ark 的{{capability}}暂未内置适配，请为该模型配置调用脚本。",
            title: "编辑渠道",
            name: "渠道名称",
            protocol: "协议",
            baseUrl: "接口地址",
